...
import { white, textLightGray, caramel ,green, alaBaster} from "../../../constants/Colors";
            ...
            <View style={styles.contentContainer}>
               ...
               <View style={styles.quickButtons}>
                  <View style={styles.recentAnnouncement}>
                     <Text style={{ fontFamily: "fontBold",fontSize:16,color:white,marginBottom:3}}>
                        {recentAnnouncement.title}
                     </Text>
                     <Text style={{ fontFamily: "fontRegular",color:white,fontWeight:100}}>
