...
const RoomChecklistDetails = ({ navigation, route }) => {
  ...
  // State for condition dropdowns - keeping the original structure
  ...
  const handleRoomChecklistFormSubmission = async (values) => {
    try {
      setLoading(true);
      ...
      Alert.alert(
        "Error",
        error?.response?.data?.message || "Failed to update room request."
      );
    } finally {
      setLoading(false);
    }
  ...
  const roomChecklistFormSchema = Yup.object({
    bunk_bed_wooden_condition: Yup.string().required("Condition is required!"),
    bunk_bed_wooden_quantity: Yup.string().required("Quantity is required!"),
    study_table_wooden_condition: Yup.string().required(
      "Condition is required!"
    ),
    study_table_wooden_quantity: Yup.string().required("Quantity is required!"),
    ...
    cloth_rack_wooden_quantity: Yup.string().required("Quantity is required!"),
    wall_mounted_light_condition: Yup.string().required(
      "Condition is required!"
    ),
    wall_mounted_light_quantity: Yup.string().required("Quantity is required!"),
    ...
    window_door_key_condition: Yup.string().required("Condition is required!"),
          ...
          <View style={styles.contentContainer}>
            ...
            <Surface style={styles.infoCard}>
              ...
              <View style={styles.infoSection}>
                ...
                <View style={styles.infoRow}>
                  <View style={styles.infoItem}>
                    ...
                    <Text style={styles.infoTextValue}>
                      {formatDate(room_acceptance.createdAt)}
                    </Text>
                  </View>
                  <View style={styles.infoItem}>
                    <Text style={styles.infoTextDesc}>Date Accepted:</Text>
                    <Text style={styles.infoTextValue}>
                      {formatDate(room_acceptance.updatedAt)}
                    </Text>
                  </View>
                </View>
                ...
                <View style={styles.infoRow}>
                  <View style={styles.infoItem}>
                    <Text style={styles.infoTextDesc}>Floor:</Text>
                    <Text style={styles.infoTextValue}>
                      {room_acceptance?.adminResponse?.floor || "Not specified"}
                    </Text>
                  </View>
                  <View style={styles.infoItem}>
                    <Text style={styles.infoTextDesc}>Block:</Text>
                    <Text style={styles.infoTextValue}>
                      {room_acceptance?.adminResponse?.block || "Not specified"}
                    </Text>
                  </View>
                  <View style={styles.infoItem}>
                    <Text style={styles.infoTextDesc}>Room No:</Text>
                    <Text style={styles.infoTextValue}>
                      {room_acceptance?.adminResponse?.roomNumber ||
                        "Not specified"}
                    </Text>
                  </View>
                </View>
            ...
            <Surface style={styles.infoCard}>
              ...
              <View style={styles.infoSection}>
                ...
                {room_acceptance.members.map((member, index) => (
            ...
            <Surface style={styles.infoCard}>
              ...
              <View style={styles.infoSection}>
                ...
                <Text style={styles.reasonText}>{room_acceptance.reason}</Text>
              </View>
            </Surface>
                    ...
                    {({
                      ...
                      return (
                        <View style={styles.form}>
                          {/* Keeping original ItemConditionDetails structure */}
                          <ItemConditionDetails
                            valueCondition={values.bunk_bed_wooden_condition}
                            valueQuantity={values.bunk_bed_wooden_quantity}
                            errorCondition={errors.bunk_bed_wooden_condition}
                            errorQuantity={errors.bunk_bed_wooden_quantity}
                            touchedCondition={touched.bunk_bed_wooden_condition}
                            touchedQuantity={touched.bunk_bed_wooden_quantity}
                            description={roomItems[0].item_name}
                            setShowCondition={setShowBunkBedWoodenCondition}
                          ...
                          />
                          <ItemConditionDetails
                            valueCondition={values.study_table_wooden_condition}
                            valueQuantity={values.study_table_wooden_quantity}
                            errorCondition={errors.study_table_wooden_condition}
                            errorQuantity={errors.study_table_wooden_quantity}
                            touchedCondition={
                            ...
                            setShowCondition={setShowStudyTableWoodenCondition}
                          ...
                          <ItemConditionDetails
                            ...
                            touchedCondition={touched.chair_wooden_condition}
                          ...
                          />
                          <ItemConditionDetails
                            valueCondition={values.cloth_rack_wooden_condition}
                            valueQuantity={values.cloth_rack_wooden_quantity}
                            errorCondition={errors.cloth_rack_wooden_condition}
                            errorQuantity={errors.cloth_rack_wooden_quantity}
                            touchedCondition={
                              touched.cloth_rack_wooden_condition
                            }
                            touchedQuantity={touched.cloth_rack_wooden_quantity}
                            description={roomItems[3].item_name}
                            setShowCondition={setShowClothRackWoodenCondition}
                          ...
                          />
                          <ItemConditionDetails
                            valueCondition={values.wall_mounted_light_condition}
                            valueQuantity={values.wall_mounted_light_quantity}
                            errorCondition={errors.wall_mounted_light_condition}
                            errorQuantity={errors.wall_mounted_light_quantity}
                            touchedCondition={
                            ...
                            setShowCondition={setShowWallMountedLightCondition}
                          ...
                          <ItemConditionDetails
                            ...
                            touchedCondition={touched.balcony_light_condition}
                            touchedQuantity={touched.balcony_light_quantity}
                          ...
                          <ItemConditionDetails
                            ...
                            touchedCondition={touched.main_door_key_condition}
                            touchedQuantity={touched.main_door_key_quantity}
                          ...
                          />
                          <ItemConditionDetails
                            valueCondition={values.window_door_key_condition}
                            valueQuantity={values.window_door_key_quantity}
                            errorCondition={errors.window_door_key_condition}
                            errorQuantity={errors.window_door_key_quantity}
                            touchedCondition={touched.window_door_key_condition}
                            touchedQuantity={touched.window_door_key_quantity}
                            description={roomItems[9].item_name}
                            setShowCondition={setShowWindowDoorKeyCondition}
