      ...
      <View style={styles.container}>
        <View style={styles.contentContainer}>
          ...
          <Text style={styles.infoTextContainer}>
            ...
            <Text style={styles.infoTextValue}>
              {room_acceptance?.adminResponse?.floor}
            </Text>
          </Text>
          <Text style={styles.infoTextContainer}>
            <Text style={styles.infoTextDesc}>Block: </Text>
            <Text style={styles.infoTextValue}>
           {room_acceptance?.adminResponse?.block}
            </Text>
          </Text>
          <Text style={styles.infoTextContainer}>
                ...
                return (
                  <View style={styles.form}>
                    ...
                    <ItemConditionDetails
                      ...
                      touchedCondition={touched.study_table_wooden_condition}
                      touchedQuantity={touched.study_table_wooden_quantity}
                    ...
                    <ItemConditionDetails
                      ...
                      touchedCondition={touched.cloth_rack_wooden_condition}
                    ...
                    <ItemConditionDetails
                      ...
                      touchedCondition={touched.wall_mounted_light_condition}
                      touchedQuantity={touched.wall_mounted_light_quantity}
